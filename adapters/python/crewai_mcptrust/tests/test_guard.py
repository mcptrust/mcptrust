...
class TestMCPTrustGuard:
    ...
    def test_argv_precedence_when_both_provided(self, mock_mcp):
    ...
    def test_check_default_non_throwing_pass_through(self, mock_mcp):
    ...
    def test_check_raise_on_fail_propagates_exception(self, mock_mcp):
    ...
    @patch("crewai_mcptrust.guard.os.path.exists")
